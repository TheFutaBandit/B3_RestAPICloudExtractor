...
if __name__ == '__main__':
    input_csv_file = '/path/to/your/input.csv'  # Replace with the actual path to your input CSV file
    output_csv_file = '/path/to/your/output.csv'  # Replace with the desired path to save the output CSV
