...
def main():
    input_csv = 'dataset/HIVE_AggregatedFiles_JavaFilter.csv'  # Input CSV file with file paths
    output_csv = 'dataset/HIVE_PublicClassFiles.csv'  # Output CSV file with public class check results
