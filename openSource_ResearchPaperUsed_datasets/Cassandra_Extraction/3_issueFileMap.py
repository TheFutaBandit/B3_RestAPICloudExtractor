...
def main():
    input_csv = 'dataset/cassandra_ARBIssues_3.csv'  # Input CSV file containing the 'Bug ID' column
    output_csv = 'dataset/cassandra_ARBFiles_3.csv'  # Output CSV file to store the results
