...
REPO_OWNER = 'apache'
REPO_NAME = 'cassandra'
BRANCH_NAME = 'cassandra-3.0'  # Branch name for the API request
...
def main():
    input_csv = 'dataset/cassandra_ARBFiles_3_JavaFilter_Grouped.csv'  # Input CSV file containing the 'File' column
    output_csv = 'dataset/cassandra_ExistingFiles_JavaFilter.csv'  # Output CSV file to store the results
