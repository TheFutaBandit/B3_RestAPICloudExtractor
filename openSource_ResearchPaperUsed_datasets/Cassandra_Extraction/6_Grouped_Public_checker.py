...
REPO_OWNER = 'apache'
REPO_NAME = 'cassandra'
BRANCH_NAME = '3.0'  # Branch name for the API request
...
def main():
    input_csv = 'dataset/cassandra_ExistingFiles_JavaFilter.csv'  # Input CSV file with file paths
    output_csv = 'dataset/cassandra_PublicClassFiles.csv'  # Output CSV file with public class check results
