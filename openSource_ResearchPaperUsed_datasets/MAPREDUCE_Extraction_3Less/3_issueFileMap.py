...
def main():
    input_csv = 'dataset/MAPREDUCE_ARBIssues_2.csv'  # Input CSV file containing the 'Bug ID' column
    output_csv = 'dataset/MAPREDUCE_ARBFiles_2.csv'  # Output CSV file to store the results
