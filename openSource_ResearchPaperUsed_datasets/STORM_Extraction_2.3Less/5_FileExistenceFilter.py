...
def main():
    input_csv = 'dataset/STORM_ARBFiles_2_JavaFilter_Grouped.csv'  # Input CSV file containing the 'File' column
    output_csv = 'dataset/STORM_ExistingFiles_JavaFilter.csv'  # Output CSV file to store the results
